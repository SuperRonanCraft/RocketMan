...
if (!global.inmenu) {
	...
	if (instance_exists(oPlayer))
		cache[0] = string(oPlayer.mygun.ammo) + "/" + string(oPlayer.mygun.clip) + " Ammo";
	...
	draw_text_transformed(RES_W - 10, RES_H - 40, cache[0], coinstextscale * 0.8, coinstextscale * 0.8, 0);
